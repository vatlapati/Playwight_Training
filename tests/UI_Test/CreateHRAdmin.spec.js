...
test('LogonToHrmPageandCreateAdminUser', async ({ page }) => {
...
// using keyboard operation
    ...
    const userName = 'Kasi' + time; 
    await page.getByRole('textbox').nth(2).fill(userName);
    await page.getByRole('textbox').nth(3).click();
    await page.getByRole('textbox').nth(3).click();
    await page.getByRole('textbox').nth(3).fill('Kasi@123');
    await page.getByRole('textbox').nth(4).click();
    await page.getByRole('textbox').nth(4).fill('Kasi@123');
