...
test.describe('E2E WebOrder Application @e2e', () => {
  test.describe.configure({mode:'serial'}); // Ensures tests run in order and share state
// This will ensure that the tests run in sequence and share the same page context
  // This is useful for scenarios where you want to maintain the state across tests, such as logging in once and performing multiple actions without reloading the page.
